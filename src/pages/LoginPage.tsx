...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background-alt px-4 py-12 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 text-center">
         <div>
          <a href="/" className="flex justify-center items-center gap-2">
            <img className="h-10 w-10 rounded-md" src={LogoImg} alt="Kanbanify" />
            <span className="text-2xl font-bold tracking-tight text-text">Kanbanify</span>
          </a>
          <h2 className="mt-6 text-2xl font-bold tracking-tight text-text">Redirecting to login...</h2>
        </div>
      </div>
    </div>
  );
