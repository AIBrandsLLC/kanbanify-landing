...
import dpaContent from '../../assets/doc/kanbanify-dpa.json';
...
type DPAContent = {
    slug: string;
    title: string;
    meta: { effective_date?: string };
    sections: Section[];
};

const content: DPAContent = dpaContent;
    ...
    return (
        <div className="mx-auto max-w-4xl px-6 py-12 lg:px-8 bg-background-light">
            ...
            {content.meta.effective_date && (
                <p className="text-sm text-text-light mb-8">Effective Date: {content.meta.effective_date}</p>
            )}
